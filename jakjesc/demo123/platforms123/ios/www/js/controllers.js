...
.controller('LoginCtrl', function($scope, $timeout, $stateParams, ionicMaterialInk, $location, Authentication, $http, $ionicModal, $log,$sessionStorage,$window, $ionicPlatform) {
...
/* exit */
 .controller('ExitCtrl', function($scope,$http,$ionicModal,$sessionStorage,$window, $location,  $log, $ionicPlatform) {
	  $window.close();	 
