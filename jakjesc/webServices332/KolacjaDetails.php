...
from
    ...
    jos_jakjesc_zamowienie_posilek_godzina h
     ...
     where    z.id_user = '$userId' and  d.dzien = '$pozostalo_dni4' and d.id_posilek_rodzaj = '$KolacjaId'";
	...
	$fetchResult = mysql_fetch_array($result, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);	
			if($fetchResult){	
				$getdata =array('status'=>'Success','mesg'=>'Show Supper Details','getDay'=>$getDayNames,'response'=>$fetchResult);	
				}else{
