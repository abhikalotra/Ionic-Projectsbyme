...
.factory('Authentication',function($http,$localStorage,$q){
...
/* DetailsBooking show like fitness , golf */
 .factory('BookingDetails',function($http,$localStorage,$q){
...
/* SniadanieDetails show like fitness , golf */
 .factory('SniadanieDetails',function($http,$localStorage,$q){
...
/* DrugiesniadanieDetail */
 .factory('DrugiesniadanieDetail',function($http,$localStorage,$q){			
  return{
    details:function(detail){
...
/* ObiadDetails */
 .factory('ObiadDetails',function($http,$localStorage,$q){			
  return{
    details:function(detail){
...
/* PodwieczorekDetails */
 .factory('PodwieczorekDetails',function($http,$localStorage,$q){			
  return{
    details:function(detail){
...
/* KolacjaDetails */
 .factory('KolacjaDetails',function($http,$localStorage,$q){			
  return{
    details:function(detail){
