...
.controller('AppCtrl', function($scope, $ionicModal, $ionicPopover, $timeout, $localStorage) {
   ...
   $scope.SessionEmail = {};
	...
	var SessionSetUserId = localStorage.getItem("SessionSetUserId");		
	var SessionSetEmail = localStorage.getItem("SessionSetEmail");		
	var SessionSetName = localStorage.getItem("SessionSetName"); 
...
.controller('LoginCtrl', function($scope, $timeout, $stateParams, ionicMaterialInk, $location, Authentication, $http, $ionicModal, $log,$localStorage,$window ) {
  ...
  $scope.$parent.clearFabs();
    ...
    ionicMaterialInk.displayEffect();
			...
			if(getResponse.status == 'Success'){
				...
				/*  localStorage.setItem("SessionSetUserId", getResponse.response.id);  
				 localStorage.setItem("SessionSetEmail", getResponse.response.email);   
				 localStorage.setItem("SessionSetName", getResponse.response.name);
				 var SessionSetUserId = localStorage.getItem("SessionSetUserId"); //console.log(SessionSetUserId);	
				 var SessionSetEmail = localStorage.getItem("SessionSetEmail"); //console.log(SessionSetId);	
				 var SessionSetName = localStorage.getItem("SessionSetName"); //console.log(SessionSetId);	
				 */
				 
				 localStorage.setItem("SessionSetUserId", getResponse.response.id);  
				 localStorage.setItem("SessionSetEmail", getResponse.response.email);   
				 localStorage.setItem("SessionSetName", getResponse.response.name);
				 var localStorageSetUserId = localStorage.getItem("SessionSetUserId"); 
				 var localStorageSetEmail = localStorage.getItem("SessionSetEmail");
				 var localStorageSetName = localStorage.getItem("SessionSetName");
...
/* logout */
 .controller('LogoutCtrl', function($scope,$http,$ionicModal,$localStorage,$window, $location, Authentication, $log) {
	 
		Authentication.logout().then(function(response){
			var SessionSetUserIds = localStorage.getItem("SessionSetUserId");	       		 
		 });	
})

//.controller('ProfileCtrl', function($scope, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, BookingDetails, $http, $ionicModal,$localStorage,$window, $location, $log) {
.controller('ProfileCtrl', function($scope, $stateParams, $timeout , ionicMaterialInk, BookingDetails, $http, $ionicModal,$localStorage,$window, $location, $log) {
		 ...
		 var datas =   {"userId":SessionSetUserId};
			...
			var abhi2 = new Array();			  
			  angular.forEach(getResponse.responsePreviousDate, function(value, key) {					
					...
					abhi2.push({start:PreviousDate.dzien,backgroundColor:'#fe7b0f',textColor: '#fff'}); 	
			  }); 
...
.controller('SniadanieCtrl', function($scope, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, SniadanieDetails, $http, $ionicModal,$localStorage,$window, $location, $log) {
...
if(SessionSetUserId){ 
window.location.href = "#/app/sniadanie";
}else{
window.location.href = "#/app/login";
} 
					if(getResponse.status == 'Success'){
...
.controller('DrugiesniadanieCtrl', function($scope, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, DrugiesniadanieDetail, $http, $ionicModal,$localStorage,$window, $location, $log) {
...
if(SessionSetUserId){ 
window.location.href = "#/app/drugiesniadanie";
}else{
window.location.href = "#/app/login";
}
...
.controller('ObiadCtrl', function($scope, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, ObiadDetails, $http, $ionicModal,$localStorage,$window, $location, $log) {
...
if(SessionSetUserId){ 
window.location.href = "#/app/obiad";
}else{
window.location.href = "#/app/login";
}
...
.controller('PodwieczorekCtrl', function($scope, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, PodwieczorekDetails, $http, $ionicModal,$localStorage,$window, $location, $log) {
...
if(SessionSetUserId){ 
window.location.href = "#/app/podwieczorek";
}else{
window.location.href = "#/app/login";
}
...
.controller('KolacjaCtrl', function($scope, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, KolacjaDetails, $http, $ionicModal,$localStorage,$window, $location, $log) {
...
if(SessionSetUserId){ 
window.location.href = "#/app/kolacja";
}else{
window.location.href = "#/app/login";
}
				 // console.log(getResponse);
...
/* exit */
 .controller('ExitCtrl', function($scope, $ionicPlatform, $ionicPopup) {
...
/* 
.controller('activityKurieraCtrl', function($scope, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, BookingDetails, $http, $ionicModal,$localStorage,$window, $location, $log) {
