    ...
    ionicMaterialInk.displayEffect();
			...
			if(getResponse.status == 'Success'){
				//console.log(getResponse.response);	   
				 ...
				 localStorage.setItem("localStorageSetUserId", getResponse.response.id);  
				 localStorage.setItem("localStorageSetEmail", getResponse.response.email);   
				 localStorage.setItem("localStorageSetName", getResponse.response.name);
				 var localStorageSetUserId = localStorage.getItem("localStorageSetUserId"); 
				 var localStorageSetEmail = localStorage.getItem("localStorageSetEmail");
				 var localStorageSetName = localStorage.getItem("localStorageSetName");
